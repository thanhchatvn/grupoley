odoo.define('pos_cupones_descuentos.tour.pos_cupones_descuentos1', function (require) {
    'use strict';

    // --- PoS Coupon Tour Basic Part 1 ---
    // Generate coupons for PosCouponTour2.

    const { PosCoupon } = require('pos_cupones_descuentos.tour.PosCouponTourMethods');
