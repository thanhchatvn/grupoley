...
class StockPicking(models.Model):
    ...
    def _is_same_location(self):
        ...
        for rec in self:
            ...
            if (user.property_warehouse_id.lot_stock_id and rec.location_dest_id
                ...
                if (user.property_warehouse_id.lot_stock_id == rec.location_dest_id or
                    user.property_warehouse_id.lot_stock_id == rec.location_id):
    ...
    def button_validate(self):
        ...
        for picking in self:
            if picking.picking_type_code == 'internal' and picking.x_is_same_location and picking.location_id.usage == 'internal':
