odoo.define('pos_ticket_template.InheritOrderReceipt', function(require) {
    'use strict';
    ...
    class InheritOrderReceipt extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    InheritOrderReceipt.template = 'OrderReceipt';

    Registries.Component.add(InheritOrderReceipt);

    return InheritOrderReceipt;
});
